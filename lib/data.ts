...
export const services = [
  {
    ...
    description: "Açılmayan, ısınan, donan veya ekran sorunu yaşayan laptoplar için hızlı arıza tespiti ve profesyonel servis.",
    bullets: ["Arıza tespiti", "Fan ve termal bakım", "Ekran, klavye, batarya kontrolü", "Veri güvenliği hassasiyeti"],
  },
  {
    title: "Bilgisayar Tamiri Ankara",
    slug: "bilgisayar-tamiri-ankara",
    kicker: "Masaüstü ve laptop",
    description: "Donanım, yazılım, performans ve sistem sorunlarında 19 yıllık servis tecrübesiyle çözüm.",
  ...
  },
  {
    ...
    kicker: "Performans",
    description: "Yavaş açılan bilgisayarlar için SSD montajı, sistem aktarımı ve temiz kurulum desteği.",
  ...
  },
  {
    ...
    description: "Silinen, kaybolan veya erişilemeyen dosyalar için güvenli ön inceleme ve veri kurtarma süreci.",
    bullets: ["Disk ön inceleme", "Silinen dosya analizi", "Harici disk desteği", "Gizlilik hassasiyeti"],
  },
  {
    title: "Format Atma Ankara",
    slug: "format-atma-ankara",
    kicker: "Windows kurulum",
    description: "Veri yedekleme, Windows kurulumu, sürücü yükleme ve temiz sistem teslimi.",
    bullets: ["Veri yedekleme", "Temiz kurulum", "Sürücü yükleme", "Temel program kurulumu"],
  },
  {
    title: "Anakart Tamiri Ankara",
    slug: "anakart-tamiri-ankara",
    kicker: "Detaylı servis",
    description: "Açılmayan, sıvı temaslı veya güç sorunu yaşayan cihazlarda anakart kontrolü.",
    bullets: ["Güç devresi kontrolü", "Sıvı temas inceleme", "Kısa devre analizi", "Onarım değerlendirmesi"],
  },
];

export const areas = [
  "Eryaman", "Etimesgut", "Elvankent", "Bağlıca", "Yapracık", "Batıkent", "Sincan", "Yenimahalle", "Çankaya", "Keçiören"
].map((name) => ({
  name,
  title: `${name} Bilgisayar Servisi`,
  slug: `${name.toLocaleLowerCase("tr-TR").replaceAll("ı","i").replaceAll("ğ","g").replaceAll("ü","u").replaceAll("ş","s").replaceAll("ö","o").replaceAll("ç","c")} -bilgisayar-servisi`.replace(/\s+/g,""),
}));
