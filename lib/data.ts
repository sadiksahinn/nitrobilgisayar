...
export const problems = [
  [
    ...
    "Açılmayan cihazlarda güç, disk, RAM ve anakart kaynaklı sorunların teknik kontrolü.",
  ],
  [
    "Laptop Şarj Olmuyor",
    "laptop-sarj-olmuyor",
    "Adaptör, batarya, şarj soketi ve anakart güç hattı kontrolü.",
  ],
  [
    "Laptop Çok Isınıyor",
    "laptop-cok-isiniyor",
    "Fan temizliği, termal macun yenileme ve hava kanalı bakımı.",
  ],
  [
    "Windows Açılmıyor",
    "windows-acilmiyor",
    "Açılış hataları, sistem dosyası sorunları ve disk kaynaklı problemler.",
  ],
  [
    "Mavi Ekran Hatası",
    "mavi-ekran-hatasi",
    "RAM, disk, sürücü veya Windows kaynaklı mavi ekran hatalarının analizi.",
  ],
  [
    "Bilgisayar Çok Yavaş",
    "bilgisayar-cok-yavas",
    "SSD yükseltme, bakım ve yazılım temizliğiyle performans iyileştirme.",
  ],
  [
    "Laptop Ekran Gelmiyor",
    "laptop-ekran-gelmiyor",
    "Panel, flex kablo, ekran kartı ve anakart görüntü hattı kontrolü.",
  ],
  [
    "Fan Çok Ses Yapıyor",
    "fan-cok-ses-yapiyor",
    "Tozlanma, rulman sesi ve ısınma kaynaklı fan sorunlarının çözümü.",
  ],
