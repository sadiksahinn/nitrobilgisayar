...
export const problems = [
  ["Bilgisayar Açılmıyor", "bilgisayar-acilmiyor", "Açılmayan bilgisayarlarda güç kaynağı, anakart, RAM, disk ve yazılım kaynaklı sorunlar teknik olarak kontrol edilir."],
